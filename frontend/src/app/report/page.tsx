...
function GovHeader({ back }: { back?: boolean }) {
  ...
  return (
    <>
      ...
      <header style={{ background: "#1B3A6B", color: "white", padding: "12px 24px", display: "flex", alignItems: "center", gap: 16, borderBottom: "3px solid #E65100" }}>
        {back && (
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 32, height: 32, background: "#E65100", borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        {result ? (
          ...
          <div style={{ background: "white", border: "1px solid #BBF7D0", borderLeft: "5px solid #16A34A", borderRadius: 8, padding: 36, boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              ...
              <button onClick={() => router.push('/dashboard')} style={{ flex: 1, background: "#E65100", color: "white", border: "none", padding: "12px 0", borderRadius: 4, fontWeight: 700, fontSize: 14, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="gov-card" style={{ padding: 24, marginBottom: 20 }}>
              <div style={{ borderLeft: "4px solid #E65100", paddingLeft: 12, marginBottom: 16 }}>
